            ...
            <div className={styles.informationsContainer}>
                <div className={styles.contentProfile}>
                    ...
                    <div className={styles.contentTextProfile}>
                        ...
                        <p>
                            Mon parcours est marqué par une évolution constante.
                            Initialement formé en architecture d'intérieur, j'ai
                            rapidement ressenti l'appel de la créativité et des
                            technologies numériques. Mes premiers pas dans le
                            domaine du développement web ont débuté dans
                            l'univers du jeu en ligne, où j'ai acquis de
                            l'expérience en louant et configurant des serveurs
                            de jeu dédiés, en y intégrant des solutions de
                            communication vocale et en mettant en place des
                            plateformes de discussion pour nos communautés. Cela
                            m'a également permis de concevoir des calendriers de
                            compétition et d'optimiser l'expérience utilisateur
                            au sein de nos équipes. C'est à cette époque que
                            j'ai découvert les outils d'
                            <a href="https://www.adobe.com/" target="_blank">
                                Adobe
                            </a>
                            , tels que Photoshop et Illustrator, que j'ai
                            utilisés pour créer des logos, des bannières et des
                            visuels pour nos projets en ligne.
                        </p>
                        <p>
                            Mon expérience s'est enrichie au fil du temps,
                            notamment une collaboration avec une mairie, où j'ai
                            géré le contenu des publications en ligne, tout en
                            assurant la maintenance technique du site. C'est à
                            ce moment-là que j'ai réalisé que le web n'était pas
                            seulement un passe-temps, mais bien une passion et
                            un métier à part entière.
                        </p>
                        <p>
                            Tout naturellement, j'ai décidé de me perfectionner
                        ...
                        <p>
                            ...
                            professionnelle. Ce site est pour moi une plateforme
                            où je peux mettre en lumière mes réalisations, mes
                            projets et mes compétences, tout en partageant les
