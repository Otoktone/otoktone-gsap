...
const Tech = () => {
    const technologies: Technology[] = [
        ...
        {
            name: 'JavaScript',
            image: '/tech/logo_javascript.webp',
            url: 'https://www.javascript.com',
        },
        {
            name: 'Kubernetes',
            image: '/tech/logo_kubernetes.webp',
            url: 'https://kubernetes.io',
        },
        {
            name: 'MySQL',
            image: '/tech/logo_mysql.webp',
            url: 'https://www.mysql.com',
        },
        {
            name: 'PHP',
            image: '/tech/logo_php.svg',
            url: 'https://www.php.net',
        },
        {
            name: 'Plesk',
            image: '/tech/logo_plesk.webp',
        ...
        {
            name: 'WordPress',
            image: '/tech/logo_wordpress.webp',
            ...
            <div className={styles.techContainer}>
                ...
                {[...Array(4)].map((_, i) => (
                    <div
                        key={i}
                        className={
                            i % 2 === 0 ? styles.leftColumn : styles.rightColumn
                        }
                    >
                        {technologies
